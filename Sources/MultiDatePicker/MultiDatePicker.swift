...
public struct MultiDatePicker_Previews: PreviewProvider {
    @State public static var oneDay = Date()
    @State public static var manyDates = [Date]()
    @State public static var dateRange: ClosedRange<Date>? = nil
